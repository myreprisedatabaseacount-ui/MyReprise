...
const AddSubCategoryPage: React.FC = () => {
    ...
    const handleInputChange = (field: keyof SubCategoryFormData, value: string | number | File | null) => {
    ...
    // Plus besoin de selectedIconOption car on utilise des SVG uploadés
            ...
            <div className="w-full relative mx-auto">
                ...
                <div className="mb-8 w-full">
                    ...
                    <p className="text-gray-600 mt-2">
                        ...
                        <span className="font-medium text-blue-600">{parentId || 'cette catégorie'}</span>
                    </p>
                </div>
                ...
                <div className="grid gap-8 w-full relative">
                    ...
                    <div className="w-full relative">
                        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6 w-full">
                            {/* Information sur la catégorie parent */}
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                <div className="flex items-center space-x-2">
                                    <Folder className="w-5 h-5 text-blue-600" />
                                    <span className="text-sm font-medium text-blue-900">
                                        Catégorie parent: {parentId}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Décrivez le contenu spécifique de cette catégorie..."
                                    dir="ltr"
                                />
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="اوصف المحتوى المحدد لهذه الفئة..."
                                    dir="rtl"
                                />
