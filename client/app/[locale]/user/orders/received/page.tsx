                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex gap-6 mb-6">
                      ...
                      <div className="space-y-36 h-7 w-36 ">
                  ...
                  >
                    ...
                    {(() => {
                      ...
                      return (
                        <div className="flex items-center gap-3">
                          {o.senderOffer && (
                            <Link href={`/${locale}/product/${o.senderOffer.id}`} className="relative flex items-start gap-2 border rounded-md p-2 max-w-[320px] hover:bg-gray-50 transition">
                              {/* Badge rôle expéditeur */}
                              <img src={o.senderOffer.mainImageUrl} alt={o.senderOffer.title} className="w-28 h-28 rounded object-cover" />
                          ...
                          <span className="text-gray-400"><ArrowRightLeft className="w-6 h-6" /></span>
                          <Link href={`/${locale}/product/${group.offer.id}`} className="relative flex items-start gap-2 border rounded-md p-2 max-w-[320px] hover:bg-gray-50 transition">
                            {/* Badge rôle receveur */}
                            <img src={group.offer.mainImageUrl} alt={group.offer.title} className="w-28 h-28 rounded object-cover grayscale" />
                            <div className="min-w-0">
                    ...
                    <div className="flex items-center justify-between mt-2">
                      ...
                      <div className="flex items-center gap-2">
                        <button className="inline-flex items-center rounded-md border px-3 py-2 text-md font-medium text-gray-700 hover:bg-gray-50">Refuser</button>
                        <button className="inline-flex items-center gap-3 rounded-md bg-emerald-600 px-4 py-2 text-md font-medium text-white hover:bg-emerald-700">
...
function PromoBanner({ createdAt }: { createdAt: string }) {
  ...
  return (
    <div className="rounded-md bg-gradient-to-r from-orange-400 to-red-500 text-white px-2 py-1 inline-flex items-center gap-2 text-[11px]">
      <img src="https://static-content-dropify.com/dropify_static_assets/img/apps/new_apps/cathedis.svg" alt="Cathedis" className="w-7 h-7" />
      <span>Cathedis</span>
      <span className="opacity-80">•</span>
      <Truck className="w-4 h-4 text-white" />
      <span className="text-white font-semibold text-sm">-15% livraison</span>
      <span className="opacity-80">•</span>
