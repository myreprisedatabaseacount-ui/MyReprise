...
const { createOffer, getOffers, getOfferById, updateOffer, deleteOffer, getCategoriesToExchange, getOffersGroupedByTopCategories } = require("../controllers/offerController.js");
